...
//添加广告计划
function adplansaveAPI(planName, group_id, slot_class, area, platform, network, mediaSelected, key_word, channel_class, s, e, budget, bid_type, price, frequency, speed, tagTarget, onSuccess) {
...
//修改广告计划
function adplansaveeditAPI(id, planName, group_id, slot_class, area, platform, network, mediaSelected, key_word, channel_class, s, e, budget, bid_type, price, frequency, speed, tagTarget, onSuccess) {
    var action_url = "/promotion/adplansave";
    var type = 'post';
    var reqData = {
        'id': id,
...
function fetchuseradstructAPI(onSuccess) {
...
//当前用户权限下指定基础模版的创意
function fetchusertemplateadsAPI(template_class, onSuccess) {
