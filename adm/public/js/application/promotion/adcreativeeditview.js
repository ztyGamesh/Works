            ...
            //添加图片预览功能
            {
                ...
                ];
                {
                    if (fatherID == imgConfig[3]) {
                        ...
                        imgObjSingle.imgCenter = $("#" + fatherID + " .kv-file-content img")[0];
                        //图片同步功能绑定点击事件
                        document.addEventListener("click",function(e) {
                            if (e.target.innerHTML == "上传" || e.target.innerHTML == "×" || e.target.innerHTML == "移除") {
                                imgObjSingle.imgCenter = $("#" + fatherID + " .kv-file-content img")[0];
...
setTimeout(function(){
    ...
    var strTemplate = {
        ...
        +'<span class="title_button" style="border:1px solid #000;border-radius: 3px;padding: 0px 8px 0px;float: right;line-height: 12px;margin: 8px 0;">按钮名称</span>'
        +'</div>'
        ...
        +'<span class="title_button" style="border:1px solid #f6f6f6;border-radius: 3px;padding: 2px 6px 2px;float: right;line-height: 12px;margin: 6px 6px 0 0;">按钮名称</span>'
        +'</div>'
        +'</div>'
        +'<img class="img_down" src="../images/down.png" alt="">'
        +'</div>',
        ...
        +'<span class="adv_addtitle">十个字的附加创意</span>'
        +'<span class="title_button" style="border:1px solid #000;border-radius: 3px;padding: 2px 8px 1px;float: right;line-height: 12px;margin: 11px 0;">按钮名称</span>'
        +'</div>'
        +'<div class="main_source" style="height: 30px;line-height: 30px;font-size: 12px;">'
        +'<span class="source_button" style="border:1px solid #000;padding: 0 2px 0;border-radius: 3px;line-height: 12px">广告</span>'
        +'<span class="adv_addsource" style="margin-left: 10px">十个字的广告来源</span>'
        ...
        +'<span class="title_button" style="border:1px solid #f6f6f6;border-radius: 3px;padding: 2px 8px 2px;float: right;line-height: 12px;margin: 5px 10px 0 0 ;clear:both">按钮名称</span>'
        +'</div>'
