...
const columns = [
  ...
  { title: <span className={styles.title}>{'总收入(元)'}</span>, dataIndex: 'income',align:'center',key:'income'},
  { title: <span className={styles.title}>{'总曝光量'}</span>, dataIndex: 'imp',align:'center',key:'imp'},
  ...
  { title: <span className={styles.title}>{'eCPM(元)'}</span>, dataIndex: 'ecpm',align:'center',key:'ecpm'},
...
const mapStateToProps = (state) => {
    return {
        time: state.mediaDashboardReducers.time,
        coverview: state.mediaDashboardReducers.coverview
    }
}
