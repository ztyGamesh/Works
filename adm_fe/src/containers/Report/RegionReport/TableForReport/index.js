...
export default class extends Component {
    ...
    updateHandle = async (isFirst) => {
        ...
        const sorterFilter = sorter.filter || (defaultSorter.filter ? defaultSorter.filter : "");
        const sorterTarget = sorter.target || (defaultSorter.target ? defaultSorter.target : "");
        const sorterIds = sorter.ids || (defaultSorter.ids ? defaultSorter.ids : "");
        const sorterDimension = sorter.dimension || (defaultSorter.dimension ? defaultSorter.dimension : "");
        const sorterReportData = sorter.report_data ||(defaultSorter.report_data ? defaultSorter.report_data : "all");
