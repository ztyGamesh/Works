...
export default class extends Component {
    ...
    updateHandle = async (isFirst) => {
        ...
        const sorterCondition = sorter.condition || (defaultSorter.condition ? defaultSorter.condition : [{}]);
        ...
        if (typeof onUpdate === 'function') {
            ...
            const { rows, total } = await onUpdate({
                ...
                sorter: {
                    ...
                    condition: sorterCondition,
                    report_data: sorterReportData
                }
            }) || {}
            this.setState({ loading: false, data: rows, total})
        }
    }
