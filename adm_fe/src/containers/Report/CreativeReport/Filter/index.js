...
import SelectorCreative from '../SelectorCreative';
...
class Filter extends Component {
    ...
    handleTemplates(x) {
        this.props.handleTemplates(x);
    }
    handleCreativeids(x) {
        this.props.handleCreativeids(x);
    }
    render() {
        return (
            <div>
                ...
                <Row>
                    <Col span={6}>
                        <SelectorTemplates getResult={this.handleTemplates.bind(this)}/>
                    </Col>
                    <Col span={6}>
                        <SelectorCreative getResult={this.handleCreativeids.bind(this)}/>
                    </Col>
                </Row>
            </div>
        );
