...
import { CarouselHandleSingle } from '../../../components/Carousel'
    ...
    render() {
        ...
        return (
            <div style={{
                ...
                {/* <div style={{ width: '32%', paddingRight: 48 }}>
                    <CreativePreview {...this.props} />
                </div> */}
            </div>
        )
    }
        ...
        return (
            <div style={{ width: '100%' }}>
                ...
                <div style={{ width: '100%', display: 'flex', justifyContent: 'space-between' }}>
                    <div style={{ width: '62%', paddingRight: 48 }}>
                        <CreativeMaterial {...props} />
                    </div>
                    <div style={{ width: '38%', paddingRight: 8 }}>
    ...
    render() {
        ...
        return (
            <div style={{ width: '100%', paddingBottom: 24, minHeight: 600 }}>
                ...
                <CarouselHandleSingle center={false}
                    index={index}
                    onChange={this.changeHandle}
                    itemKey="index"
                    data={data}
