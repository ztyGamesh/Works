...
import Filter from '../../../containers/Report/PlanReport/Filter';
import LineChart from '../../../containers/Report/PlanReport/LineChart';
import TableForReport from '../../../containers/Report/PlanReport/TableForReport';
import TableDimension from '../../../containers/Report/PlanReport/TableDimension';
import AdsDropDown from '../../../containers/Report/PlanReport/AdsDropDown';
import Toggle from '../../../containers/Report/PlanReport/Toggle';
...
import {adgroupreport,currentSetData,compareSetData, deltaTimeSet,fetchuseradstruct,useradstructSet} from './flow/PlanReportActions.js';
import {adplanColumnsUnlimited,adplanColumnsdate,adplanColumnsadgroup} from '../../../mock/Report/ColumnsMap';
...
class PlanReport extends Component {
	constructor(props) {
		...
		this.state = {
			...
			delta: 0,
			// 从mock处取得账户报表页面的报表列
			columns: Object.assign([], adplanColumnsadgroup),
            // 帮助表格组件存放查询条件的变量
			forReport: {
				dateA:{
					begin: todaySubtract(0),
	...
	renderColumns(columnsNames) {
		...
		switch (this.state.reportType) {
			case "unlimited":
				columnsModel = adplanColumnsUnlimited;
				break;
			case "date":
				columnsModel = adplanColumnsdate;
				break;
			case "adplan":
				columnsModel = adplanColumnsadgroup;
				break;
			default:
				return
		}
	...
	handleUpload() {
		// 下载表单
		var x = BUSINESSAPIHOST + '/alliancereport/exportcsv?action_name=adplanreportAction&offset=0&limit=1000000&condition=' + this.state.sorter.condition;
	...
	toggle(value) {
		...
		switch (value) {
			case "unlimited":
				currentColumes = adplanColumnsUnlimited;
				sorter.field = "period_date";
				sorter.order = "descend";
				break;
			case "date":
				currentColumes = adplanColumnsdate;
				sorter.field = "period_date";
				sorter.order = "descend";
				break;
			case "adplan":
				currentColumes = adplanColumnsadgroup;
				sorter.field = "imp";
				sorter.order = "descend";
				break;
			default:
            ...
            : <div>
                <Card style={{
                    ...
                    <Filter isCompare={this.isCompare.bind(this)}
						...
						getPlanids={this.getPlanids.bind(this)}
					/>
                </Card>
...
const mapStateToProps = (state) => {
	return {
		deltaTime:  state.planReportReducers.deltaTime
	}
}
export default connect(mapStateToProps, mapDispatchToProps)(PlanReport)
