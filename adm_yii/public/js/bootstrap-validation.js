...
!function($) {
    ...
    $.fn.valid = function(object, options, cb) {
        ...
        $('input, textarea', this).each(function() {
            ...
            if ($.inArray('required', valid) >= 0 || el.val().length > 0) {
            ...
            } else if ($.inArray('required', valid) < 0 && el.val().length === 0) {
                removeError(this);
            }
        });
    ...
    $.fn.validation.defaults = {
        ...
        icon: true      //true显示图标，false不显示
    };

    $.fn.validation.showError = function(field, msg){
//        console.log( $(field) );
        var el = $(field);
    ...
    var validateField = function(field, valid) {
        ...
        var passfield = (el.attr('passfield') ? el.attr('passfield') : null);
        var msg;
