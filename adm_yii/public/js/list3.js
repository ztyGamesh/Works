...
var List = {
    dialogOpen: false,
    htmlConfig: {
        // edit: ['<button class="edit btn btn-xs btn-primary btn-group-xs btn-default" id="btn_edit" title="修改">',
        //     '<i class="glyphicon glyphicon-edit"></i>',
        //     '</button>'],
        // detail: ['<button class="detail btn btn-xs btn-info btn-group-xs btn-default" id="btn_detail" title="详情">',
        //     '<i class="glyphicon glyphicon-th"></i>',
        //     '</button>'],
        // info: ['<button class="info btn btn-xs btn-info btn-group-xs btn-default" id="btn_info"  title="查看">',
        //     '<i class="glyphicon glyphicon-th"></i>',
        //     '</button>'],
        ...
        edit: ['<div class="edit dl-list-action-btn-wrapper"  title="修改">',
            ...
            '</div>'],
        editShield: ['<div class="editShield dl-list-action-btn-wrapper"  title="广告行业屏蔽设置">',
            '<img src="../img/icon/icon_edit.png" class="dl-list-action-btn">',
            '</div>'],
    ...
    init: function () {
        ...
        var data = this.$table.bootstrapTable('getOptions');
        //  List.$table.bootstrapTable('refresh', {
//                 query: {offset: 0}
//             });
        //  var data2 = this.$table.bootstrapTable('getBdata');
//        
// 		console.log(data2);
        ...
        setTimeout(function () {
            ...
            var xm = this.$table.bootstrapTable('getOptions');
    ...
    addItem: function () {
        ...
        // window.open(ListPageConfig.url.add);
        return;
        if (List.dialogOpen) {
            return false
        } else {
...
//     },
    ...
    infoItem: function (indexId) {
        ...
        if (ListPageConfig.actionJump && ListPageConfig.actionJump.info) {
            //window.location.href = editHtmlUrl;
            //return;
        }
        var addValdation = false;
...
//        var $table = $('#table');
    ...
    operateEvents: {
        ...
        'click .editShield': function (e, value, row, index) {
            var indexId = row[ListPageConfig.tableIndexCol];
            editShieldItem(indexId);
        },
