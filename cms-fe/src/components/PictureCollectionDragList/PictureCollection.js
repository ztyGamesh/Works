...
import CropperPics from './CropperPics';
		...
		return (
			<div className="pictureCollection">
				...
				<div className="picGroup action">
					<Button onClick={this.handleDeletePic.bind(this)}>删除</Button>
					<CropperPics src={pic} order={this.props.order} savePic={this.props.savePic}/>
					</div>
			</div>
		);
	}
