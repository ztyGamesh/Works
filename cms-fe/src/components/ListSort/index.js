...
export default class ListSort extends React.Component {
	...
	componentDidMount() {
		...
		if (window.addEventListener) {
			...
			window.attachEvent('onmousemove', this.onMouseMove.bind(this));
			window.attachEvent('ontouchmove', this.onMouseMove.bind(this));
			window.attachEvent('onmouseup', this.onMouseUp.bind(this));
			window.attachEvent('ontouchend', this.onMouseUp.bind(this));
		}
	}
	...
	render() {
		const childrenToRender = toArrayChildren(this.state.children).map(this.getChildren.bind(this));
