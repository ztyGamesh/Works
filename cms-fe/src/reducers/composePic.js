// 保存标题
const SAVE_TITLE = 'COMPOSEPIC_SAVE_TITLE';
// 保存马甲名
const SAVE_MASKMAN = 'COMPOSEPIC_SAVE_MASKMAN';
// 保存封面图 图片
const SAVE_DISPLAYINFO = 'COMPOSEPIC_SAVE_DISPLAYINFO';
// 保存分类 code
const SAVE_CATEGORY = 'COMPOSEPIC_SAVE_CATEGORY';
// 保存标签
const SAVE_TAGS = 'COMPOSEPIC_SAVE_TAGS';
// 保存用户选中的关键字
const SAVE_MACHINETAG = 'COMPOSEPIC_SAVE_MACHINETAG';
// 保存用户提取的内容类型
const SAVE_TYPE = 'COMPOSEPIC_SAVE_TYPE';
// 图集新增一行
const ADD_PIC = 'COMPOSEPIC_ADD_PIC';
// 保存图集-图片
const SAVE_PIC = 'COMPOSEPIC_SAVE_PIC';
// 保存图集-描述
const SAVE_DESCRIPTION = 'COMPOSEPIC_SAVE_DESCRIPTION';
// 保存图集-商品
const SAVE_GOODS = 'COMPOSEPIC_SAVE_GOODS';
// 图集删除一行
const DELETE_PIC = 'COMPOSEPIC_DELETE_PIC';
// 图集下移一行
const MOVE_PIC = 'COMPOSEPIC_MOVE_PIC';
// 根据拖拽行为更新图集数据的顺序
const SORTDRAG_PICS = 'COMPOSEPIC_SORTDRAG_PIC';
// 添加多列图集
const ADDPICS_PIC = 'COMPOSEPIC_ADDPICS_PIC';
// 保存用户上传封面图三图的临时变量
const SAVE_PICS = 'COMPOSEPIC_SAVE_PICS';
// 初始化数据
const INIT_DATA = 'COMPOSEPIC_INIT_DATA';
// 清空还原redux初始数据
const CLEAR_DATA = "COMPOSEPIC_CLEAR_DATA";
const initialState = {
	uid: '',//uid
	title: '', //文章标题
	marksman: 0, //文章马甲名
...
const composePic = (state = initialState, action) => {
	switch (action.type) {
		case SAVE_TITLE:
			return {
				...state,
